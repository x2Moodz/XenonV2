...
if game.CoreGui:FindFirstChild("XenonHub-Linoria-UI") then
    game.CoreGui:FindFirstChild("XenonHub-Linoria-UI"):Destroy()
end
ScreenGui.Name = "XenonHub-Linoria-UI"
...
function Library:SetWatermarkPosition(Position)
    Library.Watermark.Position = Position;
end;
